...
function Section4_left() {
    return (
        ...
        <h4 style={{ fontSize: "15px", marginLeft: "6px", display: "inline-block" }}>Spotlight<div style={{ background: "red", display: "inline-block", width: "23rem", height: "3.5px",marginLeft:"10px", marginBottom:"3px" }}></div></h4>
